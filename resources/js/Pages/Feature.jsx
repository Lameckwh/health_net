...
function Feature() {
  return (
    <div className="bg-[#F7F7F7] mt-6" id="feature">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
                <div className="p-8">
                    ...
                    <p className="text-gray-500 text-sm leading-relaxed">
                        Efficiently organize patient data including
                        demographics, medical history, and treatment
                        plans. Easily access and update records to
                        ensure seamless patient care
                    </p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
                <div className="p-8">
                    ...
                    <p className="text-gray-500 text-sm leading-relaxed">
                        ...
                        managing, and tracking patient appointments.
                        Reduce wait times and improve patient
                        satisfaction with efficient booking and
                        reminders
                    </p>
                </div>
            </div>
